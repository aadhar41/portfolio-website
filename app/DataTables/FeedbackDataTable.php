...
class FeedbackDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query) {
                return '<a class="badge badge-primary" href="'.route("admin.feedback.edit", $query->id).'" role="button">Edit</a>
                <form action="'.route("admin.feedback.destroy", $query->id ).'" method="POST">
                    '.csrf_field().'
                    '.method_field("DELETE").'
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('title')->width(80),
            Column::make('position')->width(80),
