    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query) {
                return '<a class="badge badge-primary" href="'.route("admin.blog-category.edit", $query->id).'" role="button">Edit</a>
                <form action="'.route("admin.blog-category.destroy", $query->id ).'" method="POST">
                    '.csrf_field().'
                    '.method_field("DELETE").'
