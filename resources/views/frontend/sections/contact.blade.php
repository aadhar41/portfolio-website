            ...
            <div class="col-sm-12">
                ...
                <form class="contact-form" id="contact-form">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-box">
                                <input type="text" name="form-email" id="form-email" class="input-box" placeholder="Email">
                                <label for="form-email" class="icon lb-email"><i class="fal fa-envelope"></i></label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-box">
                                <input type="text" name="form-subject" id="form-subject" class="input-box" placeholder="Subject">
