                ...
                <form action="{{route('admin.hero.update', 1)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">{{__('Hero Section')}}</h3>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="title" name="title" type="text" placeholder="{{__('Title')}}" value="{{old('title', $hero->title)}}" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="btn_url" name="btn_url" value="{{old('btn_url', $hero->btn_url)}}" type="text" placeholder="{{__('Button URL')}}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="image">{{__('Choose Background Image')}}...</label>
                                    </div>
                                </div>
                            </div>
                            @if ($hero->image)
