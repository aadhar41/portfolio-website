                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="title" name="title" type="text" placeholder="{{__('Title')}}" value="{{old('title', $about->title)}}" />
                            </div>

                            <div class="form-group">
                                <label>{{__('Description')}}</label>
                                <textarea class="form-control summernote" rows="3" id="description" name="description" placeholder="{{__('Description')}}">{!! old('description', $about->description) !!}</textarea>
                            </div>
                            <div class="form-group">
