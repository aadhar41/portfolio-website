                ...
                <form action="{{route('admin.experience.update', 1)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">{{__('Create Experience Content')}}</h3>
                            <div class="card-tools">
                                <a href="{{route('admin.experience.index')}}" class="mr-3"><i class="fa fa-list" aria-hidden="true"></i> {{__('Lists')}}</a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="email" name="email" type="email" placeholder="{{__('Email')}}" value="{{old('email', $data->email)}}" />
                            </div>
