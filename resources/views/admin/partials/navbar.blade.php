<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        <!-- Navbar Search -->
        <li class="nav-item">
            <a class="nav-link" data-widget="navbar-search" href="#" role="button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Search">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#" data-bs-toggle="tooltip" data-bs-placement="bottom" title="View all notifications">
        ...
        <li class="nav-item">
            <a class="nav-link" data-widget="fullscreen" href="#" role="button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="View Fullscreen">
