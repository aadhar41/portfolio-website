                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="title" name="title" type="text" placeholder="{{__('Title')}}" value="{{old('title')}}" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control summernote" rows="3" id="description" name="description" placeholder="{{__('Description')}}">{!! old('description') !!}</textarea>
                            </div>

                            <div class="form-group">
                                <label for="client">{{__('Client')}}</label>
                                <input class="form-control" id="client" name="client" type="text" placeholder="{{__('Client')}}" value="{{old('client')}}" />
                            </div>

                            <div class="form-group">
                                <label for="website">{{__('Website')}}</label>
                                <input class="form-control" id="website" name="website" type="text" placeholder="{{__('Website')}}" value="{{old('website')}}" />
                            </div>
